...
void
b_rulemap_deallocate(struct B_RuleMap *);

void
b_rulemap_add(struct B_RuleMap *, const struct B_AnyRule *);

struct B_AnyRule *
b_rulemap_to_rule(struct B_RuleMap *);

struct B_RuleMap *
b_rulemap_from_rule(struct B_AnyRule *);
